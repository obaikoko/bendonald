...
const WhyChooseUs = () => {
  return (
    <div className='bg-gray-50 py-16'>
      ...
      <section className='mb-16'>
        <div className='flex flex-col lg:flex-row items-center justify-between bg-white shadow-lg rounded-lg overflow-hidden'>
          ...
          <div className='lg:w-1/2 p-8'>
            <h2 className='text-3xl font-semibold mb-4 text-blue-950'>
              Academic Excellence
            </h2>
      ...
      <section className='mb-16'>
        <div className='flex flex-col lg:flex-row-reverse items-center justify-between bg-white shadow-lg rounded-lg overflow-hidden'>
          {/* Image */}
          <div className='lg:w-1/2'>
            <img
