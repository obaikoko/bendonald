...
const Onboarding = () => {
  return (
    <section className='bg-gradient-to-br from-cyan-50 to-gray-100 py-16 px-4 lg:px-16'>
      ...
      <div className='flex flex-col md:flex-row md:space-x-8 lg:space-x-12 max-w-6xl mx-auto'>
        {/* Step 1 */}
        <div className='flex-1 mb-8 md:mb-0 bg-white shadow-lg rounded-lg p-8 transition duration-300 transform hover:-translate-y-1'>
          <div className='flex items-center justify-center mb-6'>
            <FaFileAlt className='text-4xl text-blue-950' />
          </div>
        ...
        <div className='flex-1 mb-8 md:mb-0 bg-white shadow-lg rounded-lg p-8 transition duration-300 transform hover:-translate-y-1'>
          <div className='flex items-center justify-center mb-6'>
            <FaCalendarCheck className='text-4xl text-blue-950' />
          </div>
          <h3 className='text-2xl font-bold text-gray-800 mb-4 text-center'>
        ...
        {/* Step 3 */}
        <div className='flex-1 bg-white shadow-lg rounded-lg p-8 transition duration-300 transform hover:-translate-y-1'>
          <div className='flex items-center justify-center mb-6'>
            <FaUserCheck className='text-4xl text-blue-950' />
          </div>
          <h3 className='text-2xl font-bold text-gray-800 mb-4 text-center'>
